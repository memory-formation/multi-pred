...
def monitor_def():
    ...
    monitor_def4 = {}
    monitor_def3['monitor_name'] = 'bestia' # monitor to use (make sure to define monitors in exp_monitors center.
    monitor_def3['monitor_pixels']  = (2560, 1080)
    monitor_def3['monitor_width'] = 54
    monitor_def3['distance2monitor'] = 50
    monitor_def3['Hz'] = 75
...
def draw_basic(win, stim): # creates a dictionary with basic stimulus features    
    ...
    basic_stim['eye_cross'] = visual.ImageStim(win , "img/eyecross.png", pos=[-5,7], size=[7,5])
